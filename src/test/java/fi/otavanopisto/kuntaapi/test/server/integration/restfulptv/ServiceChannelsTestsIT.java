...
public class ServiceChannelsTestsIT extends AbstractIntegrationTest {
  ...
  public void testFindServiceLocationChannel() throws InterruptedException {
    ...
    given() 
      ...
      .body("addresses[0].postalCode", is("31400s"))
