package fi.metatavu.kuntaapi.server.freemarker;
...
public class FreemarkerRenderer {
  ...
  public void init() {
    ...
    configuration.setTemplateLoader(new ClassTemplateLoader(getClass().getClassLoader(), "/fi/metatavu/kuntaapi/server"));
