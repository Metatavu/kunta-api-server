...
public class ManagementWebhookHandler implements WebhookHandler {
  ...
  private boolean handleTrashTile(OrganizationId kuntaApiOrganizationId, Payload payload) {
    ...
    tileIdTaskQueue.enqueueTask(new IdTask<TileId>(true, Operation.REMOVE, tileId));
    return true;
  }
  ...
  private boolean handleTrashPost(OrganizationId kuntaApiOrganizationId, Payload payload) {
    ...
    newsArticleIdTaskQueue.enqueueTask(new IdTask<NewsArticleId>(true, Operation.REMOVE, newsArticleId));
    return true;
  }
  ...
  private boolean handleTrashBanner(OrganizationId kuntaApiOrganizationId, Payload payload) {
    ...
    bannerIdTaskQueue.enqueueTask(new IdTask<BannerId>(true, Operation.REMOVE, bannerId));
    return true;
  }
  ...
  private boolean handleTrashPage(OrganizationId kuntaApiOrganizationId, Payload payload) {
    ...
    pageIdTaskQueue.enqueueTask(new IdTask<PageId>(true, Operation.REMOVE, pageId));
    return true;
  }
  ...
  private boolean handleFragmentTrash(OrganizationId kuntaApiOrganizationId, Payload payload) {
    ...
    fragmentIdTaskQueue.enqueueTask(new IdTask<FragmentId>(true, Operation.REMOVE, fragmentId));
    return true;
  }
  ...
  private boolean handleShortlinkTrash(OrganizationId kuntaApiOrganizationId, Payload payload) {
    ...
    shortlinkIdTaskQueue.enqueueTask(new IdTask<ShortlinkId>(true, Operation.REMOVE, shortlinkId));
    return true;
  }
  ...
  private boolean handleIncidentTrash(OrganizationId kuntaApiOrganizationId, Payload payload) {
    ...
    incidentIdTaskQueue.enqueueTask(new IdTask<IncidentId>(true, Operation.REMOVE, incidentId));
    return true;
  }
  ...
  private boolean handleAnnouncementTrash(OrganizationId kuntaApiOrganizationId, Payload payload) {
    ...
    announcementIdTaskQueue.enqueueTask(new IdTask<AnnouncementId>(true, Operation.REMOVE, announcementId, null));
    return true;
  }
  ...
  private boolean handlePublishPage(OrganizationId organizationId, Payload payload) {
    ...
    pageIdTaskQueue.enqueueTask(new IdTask<PageId>(true, Operation.UPDATE, pageId, payload.getOrderIndex()));
    return true;
  }
  ...
  private boolean handlePublishBanner(OrganizationId organizationId, Payload payload) {
    ...
    bannerIdTaskQueue.enqueueTask(new IdTask<BannerId>(true, Operation.UPDATE, bannerId, payload.getOrderIndex()));
    return true;
  }
  ...
  private boolean handlePublishPost(OrganizationId organizationId, Payload payload) {
    ...
    newsArticleIdTaskQueue.enqueueTask(new IdTask<NewsArticleId>(true, Operation.UPDATE, newsArticleId, payload.getOrderIndex()));
    return true;
  }
  ...
  private boolean handleTilePublish(OrganizationId organizationId, Payload payload) {
    ...
    tileIdTaskQueue.enqueueTask(new IdTask<TileId>(true, Operation.UPDATE, tileId, payload.getOrderIndex()));
    return true;
  }
  ...
  private boolean handleFragmentPublish(OrganizationId kuntaApiOrganizationId, Payload payload) {
    ...
    fragmentIdTaskQueue.enqueueTask(new IdTask<FragmentId>(true, Operation.UPDATE, fragmentId, payload.getOrderIndex()));
    return true;
  }

  private boolean handleAnnouncementPublish(OrganizationId kuntaApiOrganizationId, Payload payload) {
    AnnouncementId announcementId = new AnnouncementId(kuntaApiOrganizationId, ManagementConsts.IDENTIFIER_NAME, payload.getId());
    announcementIdTaskQueue.enqueueTask(new IdTask<AnnouncementId>(true, Operation.UPDATE, announcementId, payload.getOrderIndex()));
    return true;
  }
  ...
  private boolean handleShortlinkPublish(OrganizationId kuntaApiOrganizationId, Payload payload) {
    ...
    shortlinkIdTaskQueue.enqueueTask(new IdTask<ShortlinkId>(true, Operation.UPDATE, shortlinkId, payload.getOrderIndex()));
    return true;
  }
  ...
  private boolean handleIncidentPublish(OrganizationId kuntaApiOrganizationId, Payload payload) {
    ...
    incidentIdTaskQueue.enqueueTask(new IdTask<IncidentId>(true, Operation.UPDATE, incidentId, payload.getOrderIndex()));
    return true;
  }
  ...
  private boolean updateAllMenus(OrganizationId kuntaApiOrganizationId) {
    ...
    if (response.isOk()) {
      for (Menu menu : response.getResponse()) {
        ...
        menuIdTaskQueue.enqueueTask(new IdTask<MenuId>(true, Operation.UPDATE, menuId, null));
      }      
