...
import fi.metatavu.kuntaapi.server.integrations.linkedevents.LinkedEventsImageLoader;
import fi.metatavu.kuntaapi.server.integrations.linkedevents.LinkedEventsTranslator;
...
public class LinkedEvenstEventEntityDiscoverJob extends EntityDiscoverJob<IdTask<EventId>> {
