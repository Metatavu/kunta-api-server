...
import fi.metatavu.kuntaapi.server.index.IndexRemoveContact;
import fi.metatavu.kuntaapi.server.index.IndexRemoveRequest;
import fi.metatavu.kuntaapi.server.index.IndexRequest;
import fi.metatavu.kuntaapi.server.index.IndexableContact;
import fi.metatavu.kuntaapi.server.integrations.KuntaApiIdFactory;
import fi.metatavu.kuntaapi.server.integrations.vcard.tasks.OrganizationVCardsTaskQueue;
...
public class VCardEntityDiscoverJob extends EntityDiscoverJob<OrganizationEntityUpdateTask> {
