...
public class OrganizationSettingProvider {
  ...
  public List<OrganizationSetting> listOrganizationSettings(OrganizationId organizationId, String key) {
    List<fi.metatavu.kuntaapi.server.persistence.model.OrganizationSetting> settings;

    if (StringUtils.isNotBlank(key)) {
      fi.metatavu.kuntaapi.server.persistence.model.OrganizationSetting setting = organizationSettingController.findOrganizationSettingByKey(organizationId, key);
      if (setting != null) {
    ...
    for (fi.metatavu.kuntaapi.server.persistence.model.OrganizationSetting setting : settings) {
  ...
  public OrganizationSetting findOrganizationSetting(OrganizationId organizationId, Long settingId) {
    fi.metatavu.kuntaapi.server.persistence.model.OrganizationSetting organizationSetting = organizationSettingController.findOrganizationSetting(settingId);
  ...
  public OrganizationSetting updateOrganizationSetting(Long organizationSettingId, String value) {
    fi.metatavu.kuntaapi.server.persistence.model.OrganizationSetting organizationSetting = organizationSettingController.findOrganizationSetting(organizationSettingId);
    if (organizationSetting == null) {
  ...
  private OrganizationSetting createOrganizationEntity(fi.metatavu.kuntaapi.server.persistence.model.OrganizationSetting organizationSetting) {
    if (organizationSetting == null) {
      return null;
    }
