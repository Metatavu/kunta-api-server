...
import fi.otavanopisto.kuntaapi.server.persistence.model.ArchivedIdentifier_;
...
//   * @return found identifier or null if non found
//   */
//  public ArchivedIdentifier findByTypeSourceAndKuntaApiId(String type, String source, String kuntaApiId) {
//    EntityManager entityManager = getEntityManager();
//
//    CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
//    CriteriaQuery<ArchivedIdentifier> criteria = criteriaBuilder.createQuery(ArchivedIdentifier.class);
...
//  }
//
//  public List<ArchivedIdentifier> listBySourceAndType(String source, String type) {
//    EntityManager entityManager = getEntityManager();
//
//    CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
//    CriteriaQuery<ArchivedIdentifier> criteria = criteriaBuilder.createQuery(ArchivedIdentifier.class);
...
//  }
//
//  public List<ArchivedIdentifier> listByOrganizationIdAndSourceAndType(String organizationKuntaApiId, String source, String type) {
//    EntityManager entityManager = getEntityManager();
//
//    CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
//    CriteriaQuery<ArchivedIdentifier> criteria = criteriaBuilder.createQuery(ArchivedIdentifier.class);
...
//  }
//
//  public ArchivedIdentifier updateOrderIndex(ArchivedIdentifier identifier, Long orderIndex) {
//    identifier.setOrderIndex(orderIndex);
//    return persist(identifier);
//  }
//  
//  public ArchivedIdentifier updateModified(ArchivedIdentifier identifier, OffsetDateTime modified) {
...
//    Root<ArchivedIdentifier> root = criteria.from(ArchivedIdentifier.class);
//    criteria.select(root.get(ArchivedIdentifier_.orderIndex));
//    criteria.where(
//      criteriaBuilder.equal(root.get(ArchivedIdentifier_.kuntaApiId), kuntaApiIdentifier)
//    );
//    
//    return getSingleResult(entityManager.createQuery(criteria));
//  }
...
//    Root<ArchivedIdentifier> root = criteria.from(ArchivedIdentifier.class);
//    criteria.multiselect(root.get(ArchivedIdentifier_.kuntaApiId), root.get(ArchivedIdentifier_.orderIndex));
//    criteria.where(root.get(ArchivedIdentifier_.kuntaApiId).in(kuntaApiIds));
//    
//    return entityManager.createQuery(criteria).getResultList();
//  }
