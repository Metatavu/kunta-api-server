...
import fi.otavanopisto.kuntaapi.server.persistence.model.StoredResource_;
...
public class StoredResourceDAO extends AbstractDAO<StoredResource> {
  ...
  public StoredResource create(Identifier identifier, String data) {
  ...
  public StoredResource findByIdentifier(Identifier identifier) {
    ...
    criteria.where(criteriaBuilder.equal(root.get(StoredResource_.identifier), identifier));
