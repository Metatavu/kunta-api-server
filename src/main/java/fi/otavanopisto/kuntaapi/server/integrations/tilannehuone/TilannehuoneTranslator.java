...
public class TilannehuoneTranslator {
  ...
  public Emergency translateEmergency(EmergencyId kuntaApiEmergencyId, fi.otavanopisto.kuntaapi.server.integrations.tilannehuone.model.Emergency tilannehuoneEmergency) {
  ...
  private List<EmergencySource> translateSources(List<fi.otavanopisto.kuntaapi.server.integrations.tilannehuone.model.EmergencySource> tilannehuoneSources) {
    ...
    for (fi.otavanopisto.kuntaapi.server.integrations.tilannehuone.model.EmergencySource tilannehuoneSource : tilannehuoneSources) {
