...
public class PtvServiceWebPageChannelIdUpdater extends EntityUpdater {
  ...
  public void timeout() {
    if (systemSettingController.isNotTestingOrTestRunning()) {
      ...
      } else if (serviceWebPageChannelsTaskQueue.isEmpty()) {
...
//        WebPageServiceChannelId channelId = new WebPageServiceChannelId(PtvConsts.IDENTIFIER_NAME, webPageChannel.getId());
