...
import fi.otavanopisto.kuntaapi.server.integrations.management.tasks.IncidentIdTaskQueue;
...
public class ManagementIncidentEntityUpdater extends EntityUpdater {
